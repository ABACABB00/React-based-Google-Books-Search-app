...
class Search extends Component {
    ...
    searchBook = (e) => {
        ...
        request
            ...
            .then((data) => {
                console.log(data);
                const clearData = this.clearData(data)
    ...
    render() {
        ...
        return (
            <div>
                <Books searchBook={this.searchBook} handleSearch={this.handleSearch} handleSort={this.handleSort} />
                <BookSearch books={sortedBooks} />
            </div>
        )
    }
}
